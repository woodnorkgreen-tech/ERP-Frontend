...
// Use computed getter/setter for two-way binding without watchers
const name = computed({
  get: () => props.modelValue.name,
  set: (value: string) => emit('update:modelValue', { ...props.modelValue, name: value })
})

const description = computed({
  get: () => props.modelValue.description,
  set: (value: string) => emit('update:modelValue', { ...props.modelValue, description: value })
})

const manager_id = computed({
  get: () => props.modelValue.manager_id,
  set: (value: number | undefined) => emit('update:modelValue', { ...props.modelValue, manager_id: value })
})

const budget = computed({
  get: () => props.modelValue.budget,
  set: (value: number | undefined) => emit('update:modelValue', { ...props.modelValue, budget: value })
})

const location = computed({
  get: () => props.modelValue.location,
  set: (value: string) => emit('update:modelValue', { ...props.modelValue, location: value })
})
