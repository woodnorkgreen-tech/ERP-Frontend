              ...
              <div class="space-y-2">
                 ...
                 <div class="relative group" ref="projectSearchContainer">
                    ...
                    <input 
                      ...
                      class="w-full pl-11 pr-10 py-3 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 focus:border-amber-500 rounded-lg text-sm font-bold text-slate-900 dark:text-white focus:ring-0 transition-all font-sans"
                    />
                    <div v-if="showProjectResults && filteredProjects.length > 0" 
                       ...
                       <div v-for="p in filteredProjects" :key="p.id" 
                          ...
                          <div class="flex justify-between items-center text-left">
                             <div>
                                <p class="text-xs font-bold text-slate-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400 uppercase font-mono">{{ p.project_id }}</p>
                                <p class="text-[9px] font-bold text-slate-400 dark:text-slate-500 uppercase truncate max-w-[200px]">{{ p.enquiry?.title }}</p>
                             </div>
                             <i class="mdi mdi-link-variant text-slate-300 group-hover:text-amber-500 transition-colors"></i>
                          </div>
                       </div>
                    </div>
